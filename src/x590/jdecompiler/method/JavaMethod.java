...
public final class JavaMethod extends JavaClassElement {
	...
	private final ObjectSupplierLazyLoading<VisibilityState> isAutogenerated;
	...
	private JavaMethod(ExtendedDataInputStream in, ClassInfo classinfo, ConstantPool pool) {
		...
		this.isAutogenerated = new ObjectSupplierLazyLoading<>(() -> initIsAutogenerated(classinfo));
	}
