...
public final class JavaMethod extends JavaClassElement {
	 ...
	 * иначе {@literal null} */
	 public @Nullable Operation inlineIfAccessMethod(Deque<Operation> arguments) {
		var modifiers = this.modifiers;
		var descriptor = this.descriptor;
		int argumentsCount = descriptor.getArgumentsCount();
		...
		if( modifiers.allOf(ACC_STATIC | ACC_SYNTHETIC) && modifiers.isPackageVisible() &&
			...
			Iterator<Operation> iter = arguments.iterator();
			for(int i = 0; i < argumentsCount; i++) {
				varTable.put(i, iter.next());
			}
	...
	public void decompile(ClassInfo classinfo) {
		...
		try {
			decompilationContext = DecompilationContext.decompile(disassemblerContext, classinfo, this,
					disassemblerContext.getInstructions(), codeAttribute.getMaxLocalsCount());
	...
	public boolean canStringify(ClassInfo classinfo) {
		var modifiers = this.modifiers;
		var config = JDecompiler.getConfig();
