...
public final class ArrayType extends RealReferenceType implements IArrayType {
	...
	public BasicType reduced() {
		...
		return reducedMemberType == memberType ? this : ArrayType.forType(reducedMemberType);
	}
	
	@Override
	public ReferenceType toDefiniteGeneric(IClassInfo classinfo, GenericParameters<GenericDeclarationType> parameters) {
		var memberType = this.memberType;
		var memberDefiniteGenericType = memberType.toDefiniteGeneric(classinfo, parameters);
		return memberDefiniteGenericType == memberType ? this : ArrayType.forType(memberDefiniteGenericType, nestingLevel);
	}
