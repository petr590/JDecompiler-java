...
import x590.jdecompiler.instruction.cast.CheckCastInstruction;
...
import x590.jdecompiler.instruction.other.IIncInstruction;
import x590.jdecompiler.instruction.other.InstanceofInstruction;
import x590.jdecompiler.instruction.other.NewInstruction;
...
public final class DisassemblerContext extends Context {
	...
	private @Nullable Instruction readInstruction() {
		switch(bytes[pos] & 0xFF) {
			...
			case 0x10: return new IConstInstruction(readByte());
			case 0x11: return new IConstInstruction(readShort());
