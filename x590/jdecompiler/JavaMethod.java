...
public class JavaMethod extends JavaClassElement {
	...
	private boolean isAutogenerated(ClassInfo classinfo) {
		...
		if(signature != null && signature.hasGenericTypes() || attributes.has("Exceptions") ||
	...
	public void writeTo(StringifyOutputStream out, ClassInfo classinfo) {
		...
		attributes.getOrDefault("Exceptions", ExceptionsAttribute.empty()).write(out, classinfo, signature);
		
		out.writeIfNotNull(attributes.getAsWritable("AnnotationDefault"), classinfo);
