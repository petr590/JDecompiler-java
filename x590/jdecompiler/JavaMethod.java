...
public class JavaMethod extends JavaClassElement {
	...
	private boolean isAutogenerated(ClassInfo classinfo) {
		...
		if(attributes.has("Signature") && attributes.<MethodSignatureAttribute>get("Signature").hasGenericTypes() || attributes.has("Exceptions") ||
			attributes.has("RuntimeVisibleAnnotations") || attributes.has("RuntimeInvisibleAnnotations")) {
			return false;
		}
	...
	public void writeTo(StringifyOutputStream out, ClassInfo classinfo) {
		...
		out.printIfNotNull(attributes.getAsWritable("Exceptions"), classinfo)
			.printIfNotNull(attributes.getAsWritable("AnnotationDefault"), classinfo);
