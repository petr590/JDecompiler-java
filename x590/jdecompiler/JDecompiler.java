...
public class JDecompiler {
	...
	public final boolean printDoubleSuffix;
	...
	public JDecompiler(String[] args) {
		ArgsNamespace arguments = new StandartArgParser("JDecompiler", "0.1").localize()
				...
				.add(new Flag("--autogenerated").help("Show synthetic fields, methods and classes generated by compiler"))
				.add(new Flag("--synthetic").help("Show bridge methods generated by compiler"))
				.add(new Flag("--bridge").help("Show methods autogenerated by compiler (such as Enum.valueOf(String) or constructor by default)"))
